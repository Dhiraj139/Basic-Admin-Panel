$(function () {
  ...
  function createTableRow(personData, index) {
    ...
    var personId = $("<td>").addClass("column-1").text(personData.id);
    var firstName = $("<td>").addClass("column-2").text(personData.firstName);
    var lastName = $("<td>").addClass("column-3").text(personData.lastName);
    var personEmail = $("<td>").addClass("column-4").text(personData.email);
    var personPhone = $("<td>").addClass("column-5").text(personData.phone);
